...
_G.packer_plugins = {
  ["DAPInstall.nvim"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/ravenxrz/DAPInstall.nvim"
  },
  LuaSnip = {
    loaded = true,
  ...
  ["go.nvim"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/ray-x/go.nvim"
  },
  ["guihua.lua"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/guihua.lua",
    url = "https://mirror.ghproxy.com/https://github.com/ray-x/guihua.lua"
  },
  nerdtree = {
    loaded = true,
  ...
  ["nvim-dap"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/ravenxrz/nvim-dap"
  },
  ["nvim-dap-ui"] = {
    loaded = true,
  ...
  ["nvim-gdb"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/sakhnik/nvim-gdb"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-surround"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/kylechui/nvim-surround"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  ["nvim-treesitter-textobjects"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/nvim-treesitter/nvim-treesitter-textobjects"
  },
  ["one-small-step-for-vimkind"] = {
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/one-small-step-for-vimkind",
    url = "https://mirror.ghproxy.com/https://github.com/jbyuki/one-small-step-for-vimkind"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ["telescope-dap.nvim"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/nvim-telescope/telescope-dap.nvim"
  },
  ...
  ["telescope-live-grep-args.nvim"] = {
    ...
    url = "https://mirror.ghproxy.com/https://github.com/nvim-telescope/telescope-live-grep-args.nvim"
  },
  ["telescope-rg.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-rg.nvim",
    url = "https://mirror.ghproxy.com/https://github.com/nvim-telescope/telescope-rg.nvim"
  },
  ["telescope-ui-select.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-ui-select.nvim",
    url = "https://mirror.ghproxy.com/https://github.com/nvim-telescope/telescope-ui-select.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
